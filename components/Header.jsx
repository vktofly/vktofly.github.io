      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="p-2 text-zinc-600 dark:text-zinc-400 hover:text-cosmic-900 dark:hover:text-white transition-colors rounded-full hover:bg-zinc-100 dark:hover:bg-white/5"
