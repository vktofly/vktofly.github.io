/**
 * Black and White SVG Icons for Navigation
 * All icons are monochrome and match the design system
 */
...
export function LibraryIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function BlogIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
